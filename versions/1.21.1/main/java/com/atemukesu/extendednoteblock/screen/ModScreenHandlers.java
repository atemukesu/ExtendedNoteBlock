...
public class ModScreenHandlers {
    public static final ScreenHandlerType<ExtendedNoteBlockScreenHandler> EXTENDED_NOTE_BLOCK_SCREEN_HANDLER = Registry
            .register(Registries.SCREEN_HANDLER, Identifier.of(ExtendedNoteBlock.MOD_ID, "extended_note_block"),
                    new ExtendedScreenHandlerType<ExtendedNoteBlockScreenHandler, PacketByteBuf>(
